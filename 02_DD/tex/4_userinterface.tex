...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=1,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=2,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
	\fbox{\includegraphics[page=4,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=3,width=\MuW\linewidth]{img/myTaxiApp}}
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=5,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
	\fbox{\includegraphics[page=10,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=6,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=7,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
	\fbox{\includegraphics[page=8,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=9,width=\MuW\linewidth]{img/myTaxiApp}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=2,width=\MuW\linewidth]{img/myTaxiAssist}}%
	\hfill%
	\fbox{\includegraphics[page=3,width=\MuW\linewidth]{img/myTaxiAssist}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=4,width=\MuW\linewidth]{img/myTaxiAssist}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=5,width=\MuW\linewidth]{img/myTaxiAssist}}%
	\hfill%
...
\begin{figure}%
	\hfill%
	\fbox{\includegraphics[page=6,width=\MuW\linewidth]{img/myTaxiAssist}}%
	\hfill%
